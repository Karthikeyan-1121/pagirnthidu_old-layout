...
var logoHoverUrl = "{% static 'admins/assets/PagirnthiduLogo.png' %}";
var logoDefaultUrl = "{% static 'admins/assets/pagirnthidu_favicon.png' %}";
$("#kt_aside").hover(
    function () {
        $('#kt_aside_logo a img').attr('src', logoHoverUrl);
    },
    function () {
        $('#kt_aside_logo a img').attr('src', logoDefaultUrl);
    }
);
